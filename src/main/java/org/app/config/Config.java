package main.java.org.app.config;
...
public class Config {
	...
	public static final String CHAINCODE_1_NAME = "PSB_Custody";
	
	public static final String CHAINCODE_1_PATH = "github.com/PSB_Custody";
